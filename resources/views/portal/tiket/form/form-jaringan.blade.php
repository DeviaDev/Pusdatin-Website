...
@section('title', 'Buat Tiket — Jaringan dan Infrastruktur Internet')
...
<div class="panel">
    ...
    <div style="display:flex; align-items:center; gap:16px; margin-bottom:24px;">
        ...
        <div>
            <h2 style="font-size:1.4rem; font-weight:700; margin:0;">Jaringan dan Infrastruktur Internet</h2>
            <p style="color:#666; font-size:.9rem; margin:2px 0 0;">Meliputi aduan gangguan ataupun permintaan layanan terkait kabel LAN, server, switch, router, firewall, serta koneksi internet.</p>
        </div>
    </div>

    <form method="POST" action="{{ route('portal.tiket.store', 'jaringan') }}" enctype="multipart/form-data" class="stack">
        @csrf
